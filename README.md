...
| 3. Manipulation | Scripted cube transfers work with padded original grippers. The current original-gripper Flybrain checkpoint fails 0/10 evaluation starts; ACT integration awaits its controller and checkpoint. |
